...
=======
        ...
        <section className="section" aria-labelledby="web-team-heading">
          <div className="container">
            <div className="text-center mb-16">
              <h2 id="web-team-heading" className="mb-4">Web Development Team</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Meet our dedicated web development team who work tirelessly to create amazing learning experiences
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-blue-600 font-medium mb-3">Head of Development Team</p>
                  <div className="space-y-2 text-gray-600">
                    <p><span className="font-medium">Contact:</span> +91 9156569060</p>
              ...
              >
                <div className="p-6">
                  <h3 className="text-2xl font-bold mb-6">Interns</h3>
                  <div className="space-y-6">
                    {/* Intern 1 */}
                    <div className="flex items-start">
                      <span className="text-xl mr-3">•</span>
                      <div>
                        <h4 className="text-xl font-medium mb-2">Gorantla Sai Tejaswini</h4>
                    ...
                    <div className="flex items-start">
                      <span className="text-xl mr-3">•</span>
                      <div>
                        <h4 className="text-xl font-medium mb-2">Amajala Bhuvana Sree Sahithi</h4>
                        <div className="flex items-center gap-4">
                          <a 
